...
**Note**: If you are trying to use Russian phone number (+7), you should use Apple Music to create your account. It should lead you to a link which avoids phone number verification.
